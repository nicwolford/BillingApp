<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<ScreeningONE.ViewModels.Account_ChangePass>" %>

<asp:Content ID="changePassTitle" ContentPlaceHolderID="TitleContent" runat="server">
	Change Password
</asp:Content>

<asp:Content ID="changePassContent" ContentPlaceHolderID="MainContent" runat="server">
