<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<ScreeningONE.ViewModels.Invoices_ComposeCurrentInvoiceReminder>"   %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Compose Current Invoice Reminder
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="art-content-wide">
        <h2>Compose Current Invoice Reminder</h2>
    </div>
    ...
    <script type='text/javascript'>
        ...
        $(function () {
            ...
            $('.btnResetEmail').click(function (e) {
                if (this == e.target)
                {
                    window.location.assign("/Invoices/ComposeCurrentInvoiceReminder");
                }
            });
