<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<ScreeningONE.ViewModels.Invoices_CurrentInvoiceRemindersToSend>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Current Invoice Reminders Preview
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="art-content-wide">
        <h2>Current Invoice Reminders Preview</h2>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr class="<%=(result.BadEmailAddress.GetValueOrDefault()? "trFailure": "trSuccess") %>">
                        <td>
                            <button type="button" name="btnRemoveMessage" class="btnRemoveMessage">Remove</button>
                    ...
                    if (!$("#cbQuickRemove").is(":checked")) {
                        ...
                        setTimeout(function () {
                            ...
                            if (confirm("Are you sure that you want to remove this message for client \"" + clientName + "\" addressed to \"" + fullName + "\"?")) {
                                $.ajax({
                                    url: "/Invoices/RemovePreviewMessageForCurrentInvoiceJSON",
                                    dataType: "json",
                                    type: "post",
                                    data: {
